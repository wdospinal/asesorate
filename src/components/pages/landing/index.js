                  ...
                  <div className="col">
                    <div className="card">
                      <div className="card-body">
                        ...
                        <div className="row space-rows" style={{ margin: "0px" }}>
                          <div className="col">
                            <div className="card cards-shadown cards-hover" data-aos="flip-left" data-aos-duration="950">
                              <div className="card-header card-header-materia"><span className="space"></span>
                                <div className="cardheader-text">
                                  <h4 id="heading-card" style={{ fontSize: '20px' }}>MATEMATICAS BASICAS</h4>
                                </div>
                              </div>
                              <div className="card-body">
                                <p className="card-text sub-text-color">Last activity:</p>
                                <p className="card-text cardbody-sub-text">2 minutes ago</p>
                              </div>
                            </div>
                          </div>
                          <div className="col">
                          ...
                          <div className="col">
                            <div className="card cards-shadown cards-hover" data-aos="flip-up" data-aos-duration="950">
                              <div className="card-header cards-header-hover card-header-materia"><span className="space"><a href="#"></a></span>
                                <div className="cardheader-text">
